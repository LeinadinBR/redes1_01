...
public class MeioAplicacao {
  private MeioFisico meioFisico;  //referencia ao meio fisico dessa unidade
  ...
  * Retorno: void
  ********************* */
  public void codificarParaBits(String mensagem, int tipoCodificacao){
    ...
    meioFisico.codificacaoEspecifica(arrayBitsFinal, tipoCodificacao);
  }
